  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        {/* Menu Items */}
        {renderMenuItem("location-outline", "Delivery address", () => handleOptionPress('address'))}
        {renderMenuItem("heart-outline", "Wish List", () => handleOptionPress('wishlist'))}
        {renderMenuItem("shield-outline", "Security", () => handleOptionPress('security'))}
        
        {/* Referral Code Section */}
        <View style={styles.referralContainer}>
          <View style={styles.menuItemLeft}>
            <Ionicons name="gift-outline" size={22} color="#333" style={styles.menuIcon} />
            <Text style={styles.menuText}>Referral code</Text>
          </View>
        </View>
        
        {renderMenuItem("help-circle-outline", "FAQ", () => handleOptionPress('faq'))}
        {renderMenuItem("star-outline", "Rate our Application", () => handleOptionPress('rate'))}
        ...
        >
          <Ionicons name="log-out-outline" size={22} color="#333" style={styles.menuIcon} />
      ...
      <View style={styles.bottomTabBar}>
        ...
        <TouchableOpacity style={styles.tabItem} onPress={goToOrders}>
        ...
        <TouchableOpacity style={styles.tabItem}>
          ...
          <Text style={styles.tabItemActive}>Account</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
